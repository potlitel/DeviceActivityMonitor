...
| \[10/02/2026\] | **InitialApiAndAudit** | `dotnet ef migrations add InitialApiAndAudit --project DAM.Infrastructure/DAM.Infrastructure.csproj --startup-project DAM.Host.WindowsService/DAM.Host.WindowsService.csproj` | Setup inicial para las bases del proyecto DAM.API. |
